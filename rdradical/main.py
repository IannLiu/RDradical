...
from rdchiral.initialization import rdradicalReaction, rdradicalReactants
...
def rdradicalRun(rxn, reactants, keep_mapnums=True, combine_enantiomers=True, return_mapped=True):
    ...
    for outcome in outcomes:
        ...
        missing_bonds = []
        for (i, j, b) in reactants.bonds_by_mapnum: # i is the atommapnum of begin atom, i is the atommapnum of end atom, b is bond
